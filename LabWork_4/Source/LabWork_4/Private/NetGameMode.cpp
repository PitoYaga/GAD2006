...
void ANetGameMode::AvatarOverlapped(ANetAvatar* AvatarA, ANetAvatar* AvatarB)
{
...
AActor* ANetGameMode::AssignTeamAndPlayerStart(AController* Player)
{
	...
	if (State)
	{
		...
		{
			State->TeamID = State->Result == EGameResult::RESULT_Won ? EPlayerTeam::TEAM_Blue : EPlayerTeam::TEAM_Red;
		}
